  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-white">Habitudes du jour</h2>
        ...
        {HABITS.map((habit) => {
          ...
          return (
            <button
              ...
              className={`w-full min-h-11 flex items-center gap-3 p-3.5 rounded-xl transition-all active:scale-95 ${
                done
            ...
            >
              ...
              <span className={`flex-1 text-left text-base font-medium ${done ? "text-white" : "text-zinc-400"}`}>
                {habit.label}
              </span>
